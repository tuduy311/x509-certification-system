...
def change_password():
    ...
    with col1:
        ...
        new_password = st.text_input(
            "New Password",
            type="password",
            help="Enter your new password (min 8 characters, must include uppercase, lowercase, number)"
        )
        ...
        if st.button("🔐 Update Password", type="primary"):
            ...
            # Check current password (mock validation)
            if current_password and current_password != "12345":  # Mock current password
